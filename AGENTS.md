...
This project is indexed by GitNexus as **bsdock** (946 symbols, 2304 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
